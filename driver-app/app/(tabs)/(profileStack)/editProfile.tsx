...
export default function Index() {
  ...
  const handleSubmit = () => {
    if(driver) {
      ...
      const [day, month, year] = driver.dateOfBirth.split("/");
      const validBirthDate =
        day && month && year && parseInt(year) <= new Date().getFullYear() - 18;
      const validPassword = password ? password.length >= 8 : false;
      ...
      <KeyboardAvoidingView style={styles.container}>
        ...
        <View style={styles.content}>
          <View
            style={[
              styles.inputView,
              errors.includes(1) ? styles.inputViewError : {},
            ]}
          >
            <View
              style={[
                styles.iconView,
                errors.includes(1) ? styles.iconViewError : {},
              ]}
            >
          ...
          <View
            style={[
              styles.inputView,
              errors.includes(2) ? styles.inputViewError : {},
            ]}
          >
            <View
              style={[
                styles.iconView,
                errors.includes(2) ? styles.iconViewError : {},
              ]}
            >
          ...
          <View
            style={[
              styles.inputView,
              errors.includes(3) ? styles.inputViewError : {},
            ]}
          >
            <View
              style={[
                styles.iconView,
                errors.includes(3) ? styles.iconViewError : {},
              ]}
            >
            ...
            <TextInput
              ...
              onChangeText={(value) => {
                if(driver){
                  setDriver({ ...driver, dateOfBirth: dateMask(value) })
                }
              }}
          ...
          <View
            style={[
              styles.inputView,
              errors.includes(4) ? styles.inputViewError : {},
            ]}
          >
            <View
              style={[
                styles.iconView,
                errors.includes(4) ? styles.iconViewError : {},
              ]}
            >
        ...
        <View style={styles.content}>
          <View
            style={[
              styles.inputView,
              errors.includes(5) ? styles.inputViewError : {},
            ]}
          >
            <View
              style={[
                styles.iconView,
                errors.includes(5) ? styles.iconViewError : {},
              ]}
            >
            ...
            <TextInput
              ...
              onChangeText={(value) => {
                if(driver?.cab){
                  setDriver({ ...driver, cab: { ...driver.cab, model: value } })
                }
              }}
              style={styles.input}
              onFocus={scrollToEnd}
          ...
          <View
            style={[
              styles.inputView,
              errors.includes(6) ? styles.inputViewError : {},
            ]}
          >
            <View
              style={[
                styles.iconView,
                errors.includes(6) ? styles.iconViewError : {},
              ]}
            >
            ...
            <TextInput
              ...
              onChangeText={(value) => {
                if(driver?.cab){
                  setDriver({ ...driver, cab: { ...driver.cab, color: value } });
                }
              }}
              style={styles.input}
              onFocus={scrollToEnd}
          ...
          <View
            style={[
              styles.inputView,
              errors.includes(7) ? styles.inputViewError : {},
            ]}
          >
            <View
              style={[
                styles.iconView,
                errors.includes(7) ? styles.iconViewError : {},
              ]}
            >
            ...
            <TextInput
              placeholder="Placa"
              value={driver?.cab?.plateNum}
              onChangeText={(value) => {
                if(driver?.cab){
                  setDriver({
                    ...driver,
                    cab: { ...driver.cab, plateNum: value.toUpperCase() },
                  });
                }
              }}
              style={styles.input}
